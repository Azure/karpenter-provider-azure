...
// generated at 2026-04-14T22:09:40Z
	...
	ResourceSkus["southcentralus"] = []compute.ResourceSku{
		{
			...
			Capabilities: &[]compute.ResourceSkuCapabilities{
				...
				{Name: lo.ToPtr("SupportedCapacityReservationTypes"), Value: lo.ToPtr("Open,Targeted")},
				...
				{Name: lo.ToPtr("vCPUsConstraintsAllowed"), Value: lo.ToPtr("1")},
		...
		},
		{
			...
			Capabilities: &[]compute.ResourceSkuCapabilities{
				...
				{Name: lo.ToPtr("PremiumIO"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("VMDeploymentTypes"), Value: lo.ToPtr("IaaS")},
				{Name: lo.ToPtr("vCPUsConstraintsAllowed"), Value: lo.ToPtr("1, 2, 4, 6, 8, 10, 12, 15, 16, 18, 20")},
		...
		},
		{
			...
			Capabilities: &[]compute.ResourceSkuCapabilities{
				...
				{Name: lo.ToPtr("PremiumIO"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("VMDeploymentTypes"), Value: lo.ToPtr("IaaS")},
				{Name: lo.ToPtr("vCPUsConstraintsAllowed"), Value: lo.ToPtr("1, 2, 4, 6, 8, 10, 12, 15, 16")},
		...
		},
		{
			...
			Capabilities: &[]compute.ResourceSkuCapabilities{
				...
				{Name: lo.ToPtr("PremiumIO"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("VMDeploymentTypes"), Value: lo.ToPtr("IaaS")},
				{Name: lo.ToPtr("vCPUsConstraintsAllowed"), Value: lo.ToPtr("1, 2")},
		...
		},
		{
			...
			Capabilities: &[]compute.ResourceSkuCapabilities{
				...
				{Name: lo.ToPtr("PremiumIO"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("VMDeploymentTypes"), Value: lo.ToPtr("IaaS")},
				{Name: lo.ToPtr("vCPUsConstraintsAllowed"), Value: lo.ToPtr("1, 2, 4")},
		...
		},
		{
			...
			Capabilities: &[]compute.ResourceSkuCapabilities{
				...
				{Name: lo.ToPtr("PremiumIO"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("VMDeploymentTypes"), Value: lo.ToPtr("IaaS")},
				{Name: lo.ToPtr("vCPUsConstraintsAllowed"), Value: lo.ToPtr("1, 2, 4, 6, 8, 10, 12, 15, 16, 18, 20, 24, 28, 30, 32, 36, 40, 44, 45, 48, 60, 64")},
		...
		},
		{
			...
			Capabilities: &[]compute.ResourceSkuCapabilities{
				...
				{Name: lo.ToPtr("PremiumIO"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("VMDeploymentTypes"), Value: lo.ToPtr("IaaS")},
				{Name: lo.ToPtr("vCPUsConstraintsAllowed"), Value: lo.ToPtr("1, 2, 4, 6, 8")},
		...
		},
		{
			...
			Capabilities: &[]compute.ResourceSkuCapabilities{
				...
				{Name: lo.ToPtr("PremiumIO"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("VMDeploymentTypes"), Value: lo.ToPtr("IaaS")},
				{Name: lo.ToPtr("vCPUsConstraintsAllowed"), Value: lo.ToPtr("1, 2, 4, 6, 8, 10, 12, 15, 16, 18, 20, 24")},
		...
		},
		{
			...
			Capabilities: &[]compute.ResourceSkuCapabilities{
				...
				{Name: lo.ToPtr("PremiumIO"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("VMDeploymentTypes"), Value: lo.ToPtr("IaaS")},
				{Name: lo.ToPtr("vCPUsConstraintsAllowed"), Value: lo.ToPtr("1, 2, 4, 6")},
		...
		{
			Name:         lo.ToPtr("Standard_NV4ads_V710_v5"),
			Tier:         lo.ToPtr("Standard"),
			Kind:         lo.ToPtr(""),
			Size:         lo.ToPtr("NV4ads_V710_v5"),
			Family:       lo.ToPtr("StandardNVadsV710v5Family"),
			ResourceType: lo.ToPtr("virtualMachines"),
			APIVersions:  &[]string{},
			Costs:        &[]compute.ResourceSkuCosts{},
			Restrictions: &[]compute.ResourceSkuRestrictions{
			...
			Capabilities: &[]compute.ResourceSkuCapabilities{
				...
				{Name: lo.ToPtr("MemoryPreservingMaintenanceSupported"), Value: lo.ToPtr("False")},
				{Name: lo.ToPtr("HyperVGenerations"), Value: lo.ToPtr("V2")},
				{Name: lo.ToPtr("DiskControllerTypes"), Value: lo.ToPtr("SCSI")},
				{Name: lo.ToPtr("SupportedCapacityReservationTypes"), Value: lo.ToPtr("Open,Targeted")},
				...
				{Name: lo.ToPtr("CpuArchitectureType"), Value: lo.ToPtr("x64")},
				{Name: lo.ToPtr("LowPriorityCapable"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("HibernationSupported"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("PremiumIO"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("VMDeploymentTypes"), Value: lo.ToPtr("IaaS")},
				{Name: lo.ToPtr("vCPUsConstraintsAllowed"), Value: lo.ToPtr("1, 2, 4")},
				{Name: lo.ToPtr("vCPUsAvailable"), Value: lo.ToPtr("4")},
				{Name: lo.ToPtr("vCPUsPerCore"), Value: lo.ToPtr("2")},
				{Name: lo.ToPtr("CombinedTempDiskAndCachedIOPS"), Value: lo.ToPtr("18000")},
				{Name: lo.ToPtr("CombinedTempDiskAndCachedReadBytesPerSecond"), Value: lo.ToPtr("250000000")},
				{Name: lo.ToPtr("CombinedTempDiskAndCachedWriteBytesPerSecond"), Value: lo.ToPtr("250000000")},
				{Name: lo.ToPtr("CachedDiskBytes"), Value: lo.ToPtr("30064771072")},
				{Name: lo.ToPtr("UncachedDiskIOPS"), Value: lo.ToPtr("7600")},
				{Name: lo.ToPtr("UncachedDiskBytesPerSecond"), Value: lo.ToPtr("180000000")},
				{Name: lo.ToPtr("NvmeDiskSizeInMiB"), Value: lo.ToPtr("262144")},
				{Name: lo.ToPtr("NvmeSizePerDiskInMiB"), Value: lo.ToPtr("262144")},
				{Name: lo.ToPtr("NvmeMaxReadIops"), Value: lo.ToPtr("75000")},
				{Name: lo.ToPtr("NvmeMaxWriteIops"), Value: lo.ToPtr("30000")},
				{Name: lo.ToPtr("NvmeMaxReadBytesPerSecond"), Value: lo.ToPtr("360000000")},
				{Name: lo.ToPtr("NvmeMaxWriteBytesPerSecond"), Value: lo.ToPtr("180000000")},
				{Name: lo.ToPtr("EphemeralOSDiskSupported"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("EncryptionAtHostSupported"), Value: lo.ToPtr("True")},
				{Name: lo.ToPtr("CapacityReservationSupported"), Value: lo.ToPtr("False")},
				{Name: lo.ToPtr("AcceleratedNetworkingEnabled"), Value: lo.ToPtr("True")},
