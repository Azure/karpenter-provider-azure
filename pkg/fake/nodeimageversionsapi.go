...
var (
	nodeImageVersionsSnapshotData = []*armcontainerservice.NodeImageVersion{
		{
			FullName: lo.ToPtr("AKSUbuntuEdgeZone-2204gen2containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntuEdgeZone"),
			SKU:      lo.ToPtr("2204gen2containerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntuEdgeZone-2404containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntuEdgeZone"),
			SKU:      lo.ToPtr("2404containerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2004fipscontainerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2004fipscontainerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSWindows-2019-containerd-17763.8389.260210"),
			OS:       lo.ToPtr("AKSWindows"),
			SKU:      lo.ToPtr("windows-2019-containerd"),
			Version:  lo.ToPtr("17763.8389.260210"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2604minimalgen2containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2604minimalgen2containerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSWindows-2025-gen2-26100.33296.260812"),
			OS:       lo.ToPtr("AKSWindows"),
			SKU:      lo.ToPtr("windows-2025-gen2-tl"),
			Version:  lo.ToPtr("26100.33296.260812"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinux-V3gen2-202608.26.0"),
		...
		{
			FullName: lo.ToPtr("AKSUbuntu-2204containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2204containerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2204gen2containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2204gen2containerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		...
		{
			FullName: lo.ToPtr("AKSUbuntu-2204gen2fipsTLcontainerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
		...
		{
			FullName: lo.ToPtr("AKSFlatcar-flatcargen2arm64-202607.02.0"),
			OS:       lo.ToPtr("AKSFlatcar"),
			SKU:      lo.ToPtr("flatcargen2arm64"),
			Version:  lo.ToPtr("202607.02.0"),
		},
		{
			FullName: lo.ToPtr("AKSWindows-2025-26100.33296.260812"),
			OS:       lo.ToPtr("AKSWindows"),
			SKU:      lo.ToPtr("windows-2025"),
			Version:  lo.ToPtr("26100.33296.260812"),
		},
		{
			FullName: lo.ToPtr("AKSWindows-23H2-gen2-25398.2330.260513"),
			OS:       lo.ToPtr("AKSWindows"),
			SKU:      lo.ToPtr("windows-23H2-gen2"),
			Version:  lo.ToPtr("25398.2330.260513"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinux-V3fips-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
			SKU:      lo.ToPtr("V3fips"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinux-V3gen2TL-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
		...
		{
			FullName: lo.ToPtr("AKSAzureLinux-V3gen2arm64fips-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
			SKU:      lo.ToPtr("V3gen2arm64fips"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2204gen2arm64containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
		...
		{
			FullName: lo.ToPtr("AKSAzureLinux-V3katagen2-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
			SKU:      lo.ToPtr("V3katagen2"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2404gen2arm64containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2404gen2arm64containerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSWindows-2022-containerd-gen2-20348.5499.260812"),
			OS:       lo.ToPtr("AKSWindows"),
			SKU:      lo.ToPtr("windows-2022-containerd-gen2"),
			Version:  lo.ToPtr("20348.5499.260812"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinux-V3-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
			SKU:      lo.ToPtr("V3"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinux-OSGuardV3gen2fipsTL-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
			SKU:      lo.ToPtr("OSGuardV3gen2fipsTL"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2204gen2TLcontainerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
		...
		{
			FullName: lo.ToPtr("AKSUbuntuEdgeZone-2404gen2containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntuEdgeZone"),
			SKU:      lo.ToPtr("2404gen2containerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2204fipscontainerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2204fipscontainerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSWindows-2022-containerd-20348.5499.260812"),
			OS:       lo.ToPtr("AKSWindows"),
			SKU:      lo.ToPtr("windows-2022-containerd"),
			Version:  lo.ToPtr("20348.5499.260812"),
		},
		{
			FullName: lo.ToPtr("AKSWindows-23H2-25398.2330.260513"),
			OS:       lo.ToPtr("AKSWindows"),
			SKU:      lo.ToPtr("windows-23H2"),
			Version:  lo.ToPtr("25398.2330.260513"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinux-V3gen2fips-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
			SKU:      lo.ToPtr("V3gen2fips"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSFlatcar-flatcargen2-202607.02.0"),
			OS:       lo.ToPtr("AKSFlatcar"),
			SKU:      lo.ToPtr("flatcargen2"),
			Version:  lo.ToPtr("202607.02.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2404containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2404containerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinux-aclgen2arm64fipsTL-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
		...
		{
			FullName: lo.ToPtr("AKSAzureLinux-aclgen2arm64TL-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
		...
		{
			FullName: lo.ToPtr("AKSUbuntu-2004gen2CVMcontainerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2004gen2CVMcontainerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2004gen2fipscontainerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2004gen2fipscontainerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2204gen2fipscontainerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2204gen2fipscontainerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinux-V3gen2arm64-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
			SKU:      lo.ToPtr("V3gen2arm64"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2404gen2CVMcontainerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2404gen2CVMcontainerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2604minimalgen2arm64containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2604minimalgen2arm64containerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2404gen2TLcontainerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
		...
		{
			FullName: lo.ToPtr("AKSAzureLinuxEdgeZone-V3-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinuxEdgeZone"),
			SKU:      lo.ToPtr("V3"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
		...
		{
			FullName: lo.ToPtr("AKSUbuntu-2404gen2arm64gbcontainerd-202602.19.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2404gen2arm64gbcontainerd"),
			Version:  lo.ToPtr("202602.19.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntu-2404gen2containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntu"),
			SKU:      lo.ToPtr("2404gen2containerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSUbuntuEdgeZone-2204containerd-202608.26.0"),
			OS:       lo.ToPtr("AKSUbuntuEdgeZone"),
			SKU:      lo.ToPtr("2204containerd"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinux-aclgen2fipsTL-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
			SKU:      lo.ToPtr("aclgen2fipsTL"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinux-aclgen2TL-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
			SKU:      lo.ToPtr("aclgen2TL"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinux-V3gen2CVM-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinux"),
			SKU:      lo.ToPtr("V3gen2CVM"),
			Version:  lo.ToPtr("202608.26.0"),
		},
		{
			FullName: lo.ToPtr("AKSAzureLinuxEdgeZone-V3gen2-202608.26.0"),
			OS:       lo.ToPtr("AKSAzureLinuxEdgeZone"),
			SKU:      lo.ToPtr("V3gen2"),
			Version:  lo.ToPtr("202608.26.0"),
		},
