...
// +kubebuilder:validation:XValidation:message="FIPS is not yet supported for Ubuntu2204 or Ubuntu2404",rule="has(self.imageFamily) && has(self.fipsMode) ? !((self.imageFamily == 'Ubuntu2204' || self.imageFamily == 'Ubuntu2404') && self.fipsMode == 'FIPS') : true"
type AKSNodeClassSpec struct {
	...
	// +kubebuilder:default=Ubuntu2404
