...
var _ = Describe("CEL/Validation", func() {
	...
	Context("ImageFamily, FIPSMode, and TrustedLaunch", func() {
		DescribeTable("should only accept valid ImageFamily, FIPSMode, and TrustedLaunch combinations", func(imageFamily string, fipsMode *v1alpha2.FIPSMode, trustedLaunch bool, expected bool) {
			...
			Entry("AzureContainerLinux should succeed", v1alpha2.AzureContainerLinuxImageFamily, nil, false, true),
			Entry("AzureContainerLinux with FIPS should succeed", v1alpha2.AzureContainerLinuxImageFamily, &v1alpha2.FIPSModeFIPS, false, true),
			Entry("AzureContainerLinux with explicit TrustedLaunch should succeed", v1alpha2.AzureContainerLinuxImageFamily, nil, true, true),
			Entry("AzureContainerLinux with FIPS and explicit TrustedLaunch should succeed", v1alpha2.AzureContainerLinuxImageFamily, &v1alpha2.FIPSModeFIPS, true, true),
		...
		It("should reject disabled TrustedLaunch for AzureContainerLinux", func() {
			nodeClass := &v1alpha2.AKSNodeClass{
				...
				Spec: v1alpha2.AKSNodeClassSpec{
					...
					Security: &v1alpha2.Security{TrustedLaunch: &v1alpha2.TrustedLaunch{
						VTPM: lo.ToPtr(false),
					}},
				},
			}
