...
var _ = Describe("Hash", func() {
	...
	DescribeTable(
		...
		Entry("SpotMaxPrice", "7767519518537902867", v1alpha2.AKSNodeClass{Spec: v1alpha2.AKSNodeClassSpec{SpotMaxPrice: lo.ToPtr(float64(0.5))}}),
	)
	...
	DescribeTable("should change hash when static fields are updated", func(changes v1alpha2.AKSNodeClass) {
		...
		Entry("SpotMaxPrice", v1alpha2.AKSNodeClass{Spec: v1alpha2.AKSNodeClassSpec{SpotMaxPrice: lo.ToPtr(float64(0.5))}}),
	)
