...
var _ = Describe("Hash", func() {
	...
	DescribeTable(
		...
		Entry("ArtifactStreaming.Enabled", "9015667203941744292", v1alpha2.AKSNodeClass{Spec: v1alpha2.AKSNodeClassSpec{ArtifactStreaming: &v1alpha2.ArtifactStreaming{Enabled: lo.ToPtr(true)}}}),
	)
