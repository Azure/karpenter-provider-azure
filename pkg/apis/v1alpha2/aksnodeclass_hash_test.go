...
var _ = Describe("Hash", func() {
	...
	DescribeTable(
		...
		Entry("ArtifactStreaming.Mode", "9015667203941744292", v1alpha2.AKSNodeClass{Spec: v1alpha2.AKSNodeClassSpec{ArtifactStreaming: &v1alpha2.ArtifactStreamingSettings{Mode: v1alpha2.ArtifactStreamingModeEnabled}}}),
	)
	...
	DescribeTable("should change hash when static fields are updated", func(changes v1alpha2.AKSNodeClass) {
		...
		Entry("ArtifactStreaming.Mode", v1alpha2.AKSNodeClass{Spec: v1alpha2.AKSNodeClassSpec{ArtifactStreaming: &v1alpha2.ArtifactStreamingSettings{Mode: v1alpha2.ArtifactStreamingModeEnabled}}}),
	)
