...
// +kubebuilder:validation:XValidation:message="FIPS is not supported for Windows image families",rule="!has(self.fipsMode) || self.fipsMode != 'FIPS' || !has(self.imageFamily) || !(self.imageFamily in ['Windows2019','Windows2022','Windows2025','WindowsAnnual'])"
// +kubebuilder:validation:XValidation:message="linuxOSConfig is not supported for Windows image families",rule="!has(self.linuxOSConfig) || !has(self.imageFamily) || !(self.imageFamily in ['Windows2019','Windows2022','Windows2025','WindowsAnnual'])"
...
type AKSNodeClassSpec struct {
	...
	// +default="Ubuntu"
	// +kubebuilder:validation:Enum:={Ubuntu,Ubuntu2204,Ubuntu2404,AzureLinux,Windows2019,Windows2022,Windows2025,WindowsAnnual}
	// +optional
