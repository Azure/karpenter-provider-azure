...
var _ = Describe("Hash", func() {
	...
	DescribeTable(
		...
		Entry("SpotMaxPrice", "6122771721045914205", v1beta1.AKSNodeClass{Spec: v1beta1.AKSNodeClassSpec{SpotMaxPrice: lo.ToPtr("0.5")}}),
	)
	...
	DescribeTable("should change hash when static fields are updated", func(changes v1beta1.AKSNodeClass) {
		...
		Entry("SpotMaxPrice", v1beta1.AKSNodeClass{Spec: v1beta1.AKSNodeClassSpec{SpotMaxPrice: lo.ToPtr("0.5")}}),
	)
