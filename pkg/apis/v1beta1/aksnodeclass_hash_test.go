...
var _ = Describe("Hash", func() {
	...
	DescribeTable(
		...
		Entry("CapacityReservationGroupID", "7932792935039748593", v1beta1.AKSNodeClass{Spec: v1beta1.AKSNodeClassSpec{CapacityReservationGroupID: lo.ToPtr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Compute/capacityReservationGroups/crg1")}}),
	...
	DescribeTable("should change hash when static fields are updated", func(changes v1beta1.AKSNodeClass) {
		...
		Entry("CapacityReservationGroupID", v1beta1.AKSNodeClass{Spec: v1beta1.AKSNodeClassSpec{CapacityReservationGroupID: lo.ToPtr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Compute/capacityReservationGroups/crg1")}}),
