...
var _ = Describe("Hash", func() {
	...
	DescribeTable(
		...
		Entry("ArtifactStreaming.Enabled", "9015667203941744292", v1beta1.AKSNodeClass{Spec: v1beta1.AKSNodeClassSpec{ArtifactStreaming: &v1beta1.ArtifactStreaming{Enabled: lo.ToPtr(true)}}}),
	)
