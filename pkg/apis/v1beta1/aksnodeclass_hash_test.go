...
var _ = Describe("Hash", func() {
	...
	DescribeTable(
		...
		Entry("PodSubnetID", "4997215710008963190", v1beta1.AKSNodeClass{Spec: v1beta1.AKSNodeClassSpec{PodSubnetID: lo.ToPtr("pod-subnet-id")}}),
		Entry("PodIPAllocationMode", "14922079954447092322", v1beta1.AKSNodeClass{Spec: v1beta1.AKSNodeClassSpec{PodIPAllocationMode: lo.ToPtr("StaticBlock")}}),
	...
	DescribeTable("should change hash when static fields are updated", func(changes v1beta1.AKSNodeClass) {
		...
		Entry("PodSubnetID", v1beta1.AKSNodeClass{Spec: v1beta1.AKSNodeClassSpec{PodSubnetID: lo.ToPtr("pod-subnet-id")}}),
		Entry("PodIPAllocationMode", v1beta1.AKSNodeClass{Spec: v1beta1.AKSNodeClassSpec{PodIPAllocationMode: lo.ToPtr("StaticBlock")}}),
