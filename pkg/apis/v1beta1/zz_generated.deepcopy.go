...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Patching) DeepCopyInto(out *Patching) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Patching.
func (in *Patching) DeepCopy() *Patching {
	if in == nil {
		return nil
	}
	out := new(Patching)
