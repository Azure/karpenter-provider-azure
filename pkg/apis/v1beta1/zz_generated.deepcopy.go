...
func (in *AKSNodeClassSpec) DeepCopyInto(out *AKSNodeClassSpec) {
	*out = *in
	...
	if in.UltraSSD != nil {
		in, out := &in.UltraSSD, &out.UltraSSD
		*out = new(UltraSSD)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UltraSSD) DeepCopyInto(out *UltraSSD) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UltraSSD.
func (in *UltraSSD) DeepCopy() *UltraSSD {
	if in == nil {
		return nil
	}
	out := new(UltraSSD)
