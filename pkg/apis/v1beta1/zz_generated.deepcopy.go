...
func (in *AKSNodeClassSpec) DeepCopyInto(out *AKSNodeClassSpec) {
	*out = *in
	...
	if in.CapacityBlocks != nil {
		in, out := &in.CapacityBlocks, &out.CapacityBlocks
		*out = make([]CapacityBlockSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CapacityBlockSpec) DeepCopyInto(out *CapacityBlockSpec) {
	*out = *in
	if in.SKUName != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CapacityBlockSpec.
func (in *CapacityBlockSpec) DeepCopy() *CapacityBlockSpec {
	if in == nil {
		return nil
	}
	out := new(CapacityBlockSpec)
	in.DeepCopyInto(out)
	return out
}
