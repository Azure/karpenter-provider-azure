...
var _ = Describe("CEL/Validation", func() {
	...
	Context("NetworkSecurityGroupID", func() {
		DescribeTable("Should only accept valid NetworkSecurityGroupID", func(networkSecurityGroupID string, expected bool) {
			...
			Entry("should allow mixed casing in all the names", "/subscriptions/12345678-1234-1234-1234-123456789012/resourceGroups/RGName/providers/Microsoft.Network/networkSecurityGroups/Workers-NSG", true),
			Entry("missing resourceGroups in path", "/subscriptions/12345678-1234-1234-1234-123456789012/rgname/providers/Microsoft.Network/networkSecurityGroups/workers-nsg", false),
			...
			Entry("wrong resource type (subnet)", "/subscriptions/12345678-1234-1234-1234-123456789012/resourceGroups/rgname/providers/Microsoft.Network/virtualNetworks/vnet/subnets/subnet", false),
