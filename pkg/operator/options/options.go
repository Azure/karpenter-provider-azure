...
func (o *Options) AddFlags(fs *coreoptions.FlagSet) {
	...
	fs.StringVar(&o.NodeResourceGroup, "node-resource-group", env.WithDefaultString("AZURE_NODE_RESOURCE_GROUP", ""), "[REQUIRED] The Azure resource group where node VMs will be created. For AKS, this is the MC_ resource group managed by AKS. For non-AKS (azurevm mode), this is any resource group where you want VMs provisioned.")
