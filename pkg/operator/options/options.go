...
func (o *Options) AddFlags(fs *coreoptions.FlagSet) {
	...
	fs.StringVar(&o.PodIPAllocationMode, "pod-ip-allocation-mode", env.WithDefaultString("POD_IP_ALLOCATION_MODE", ""), "The pod IP allocation mode for clusters using Azure CNI with pod subnet. DynamicIndividual is required when --pod-subnet-id is set. StaticBlock is not supported.")
