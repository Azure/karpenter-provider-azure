...
func (r *reconciler) reconcileCRD(ctx context.Context, cacert []byte, key string) error {
	...
	if crd.Spec.Conversion == nil ||
		...
		(crd.Spec.Conversion.Webhook.ClientConfig.Service == nil && crd.Spec.Conversion.Webhook.ClientConfig.URL == nil) { // AKS customized
	...
	// AKS customized
	if crd.Spec.Conversion.Webhook.ClientConfig.Service != nil { // This line is changed from upstream
