...
var _ = Describe("Recently Used Versions", func() {
	DescribeTable("snapshots the previous effective pair",
		func(oldKubernetesVersion, newKubernetesVersion, oldImageVersion, newImageVersion string, imagesReady, expectSnapshot bool) {
		...
		Entry("when the image changes", "1.31.0", "1.31.0", "202601.01.0", "202602.01.0", true, true),
		Entry("when the Kubernetes version changes", "1.31.0", "1.32.0", "202601.01.0", "202601.01.0", true, true),
		Entry("when the effective pair does not change", "1.31.0", "1.31.0", "202601.01.0", "202601.01.0", true, false),
		Entry("when the previous images were not ready", "1.31.0", "1.32.0", "202601.01.0", "202601.01.0", false, false),
	)
})
