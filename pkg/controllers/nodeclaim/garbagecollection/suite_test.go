...
var _ = BeforeSuite(func() {
	...
	env = coretest.NewEnvironment(
		coretest.WithCRDs(apis.CRDs...), coretest.WithCRDs(v1alpha1.CRDs...),
		coretest.WithFieldIndexers(coretest.NodeProviderIDFieldIndexer(ctx), coretest.NodeClaimProviderIDFieldIndexer(ctx)),
	)
	...
	InstanceGCController = garbagecollection.NewInstance(env.Client, cloudProvider, azureEnv.VMInstanceProvider)
