...
// suite_test.go is the test suite entrypoint and shared setup for garbage collection tests.
// NO TESTS LIVE HERE. Tests are in suite_aksmachine_test.go organized by instance type (VM / AKS Machine / Mixed).
