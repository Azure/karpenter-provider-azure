...
// ExpectProvisionedAndDrained provisions pods and waits for async polling goroutines to complete.
...
// CreateAndDrain calls cloudProvider.Create and waits for async polling goroutines to complete.
