...
func Options(overrides ...OptionsFields) *azoptions.Options {
	...
	return &azoptions.Options{
		...
		SubnetID:                       lo.FromPtrOr(options.SubnetID, "/subscriptions/12345678-1234-1234-1234-123456789012/resourceGroups/test-resourceGroup/providers/Microsoft.Network/virtualNetworks/karpentervnet/subnets/karpentersub"),
