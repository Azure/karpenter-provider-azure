...
func (u CustomImage) Name() string {
	return v1alpha2.CustomImageFamily
}

func (u CustomImage) DefaultImages() []DefaultImageOutput {
...
func (u CustomImage) ScriptlessCustomData(kubeletConfig *bootstrap.KubeletConfiguration, taints []v1.Taint, labels map[string]string, caBundle *string, _ *cloudprovider.InstanceType) bootstrap.Bootstrapper {
...
// UserData returns the default userdata script for the image Family
func (u CustomImage) CustomScriptsNodeBootstrapping(kubeletConfig *bootstrap.KubeletConfiguration, taints []v1.Taint, startupTaints []v1.Taint, labels map[string]string, instanceType *cloudprovider.InstanceType, imageDistro string, storageProfile string) customscriptsbootstrap.Bootstrapper {
