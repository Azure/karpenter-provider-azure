...
func TestPrepareKubeletConfigurationSoftEviction(t *testing.T) {
	...
	t.Run("enabled", func(t *testing.T) {
		ctx := options.ToContext(context.Background(), &options.Options{EnableNodeHardening: true})
		configuration := prepareKubeletConfiguration(ctx, instanceType, nodeClass)
