...
func prepareKubeletConfiguration(instanceType *cloudprovider.InstanceType, nc *corev1beta1.NodeClaim) *bootstrap.KubeletConfiguration {
	...
	return &bootstrap.KubeletConfiguration{KubeletConfiguration: *kubeletConfig}
}
