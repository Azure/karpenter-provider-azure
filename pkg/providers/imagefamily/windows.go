...
const (
	Windows2019ContainerdImageDefinition = "windows-2019-containerd"
	...
	WindowsAnnual23H2Gen2ImageDefinition = "windows-23H2-gen2"
	WindowsAnnual23H2ImageDefinition     = "windows-23H2"
)
...
func (w Windows) DefaultImages(useSIG bool, fipsMode *v1beta1.FIPSMode) []types.DefaultImageOutput {
	...
	switch w.Family {
	case v1beta1.Windows2019ImageFamily:
		return []types.DefaultImageOutput{
			windowsImage(Windows2019ContainerdImageDefinition, v1beta1.HyperVGenerationV1, "aks-windows-2019-containerd"),
		}
	...
	case v1beta1.WindowsAnnualImageFamily:
		return []types.DefaultImageOutput{
			windowsImage(WindowsAnnual23H2Gen2ImageDefinition, v1beta1.HyperVGenerationV2, "aks-windows-23H2-gen2"),
			windowsImage(WindowsAnnual23H2ImageDefinition, v1beta1.HyperVGenerationV1, "aks-windows-23H2"),
		}
