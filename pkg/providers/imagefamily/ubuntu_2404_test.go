...
func TestUbuntu2404_CustomScriptsNodeBootstrapping(t *testing.T) {
	...
	ubuntu := &imagefamily.Ubuntu2404{
		Options: &template.StaticParameters{
			...
			NetworkSecurityGroupName:       "aks-agentpool-test1234-nsg",
			RouteTableName:                 "aks-agentpool-test1234-routetable",
	...
	bootstrapper := ubuntu.CustomScriptsNodeBootstrapping(
		nil, nil, nil, nil, nil, "test-distro", "Standard_LRS", nil, nil, nil, nil, nil, false, false,
	)
