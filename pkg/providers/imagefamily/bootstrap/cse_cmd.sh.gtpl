...
CSE_CONFIG_GPU_FILEPATH="{{.CSEConfigGPUScriptFilepath}}"
CSE_CONFIG_LOCALDNS_FILEPATH="{{.CSEConfigLocalDNSScriptFilepath}}"
CSE_CONFIG_KUBELET_FILEPATH="{{.CSEConfigKubeletScriptFilepath}}"
CSE_CONFIG_NETWORK_FILEPATH="{{.CSEConfigNetworkScriptFilepath}}"
CSE_CONFIG_ADDONS_FILEPATH="{{.CSEConfigAddonsScriptFilepath}}"
CSE_CONFIG_CHRONY_FILEPATH="{{.CSEConfigChronyScriptFilepath}}"
