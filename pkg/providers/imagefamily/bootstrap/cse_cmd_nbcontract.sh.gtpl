...
NETWORK_PLUGIN={{getStringFromNetworkPluginType .GetClusterConfig.GetClusterNetworkConfig.GetNetworkPlugin}}
NETWORK_POLICY="{{getStringFromNetworkPolicyType .GetClusterConfig.GetClusterNetworkConfig.GetNetworkPolicy}}"
VNET_CNI_PLUGINS_URL={{.GetClusterConfig.GetClusterNetworkConfig.GetVnetCniPluginsUrl}}
CNI_PLUGINS_URL={{.GetClusterConfig.GetClusterNetworkConfig.GetCniPluginsUrl}}
...
ENSURE_NO_DUPE_PROMISCUOUS_BRIDGE={{getEnsureNoDupePromiscuousBridge .GetClusterConfig.GetClusterNetworkConfig}}
