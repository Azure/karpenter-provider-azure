...
{{end}}
IS_KRUSTLET="{{getIsKrustlet .WorkloadRuntime}}"
IPV6_DUAL_STACK_ENABLED="{{.Ipv6DualStackEnabled}}"
ENABLE_UNATTENDED_UPGRADES={{.EnableUnattendedUpgrade}}
ENSURE_NO_DUPE_PROMISCUOUS_BRIDGE={{getEnsureNoDupePromiscuousBridge .NetworkConfig.NetworkPlugin .NetworkConfig.NetworkPolicy}}
...
HAS_CUSTOM_SEARCH_DOMAIN="{{getHasSearchDomain .CustomSearchDomain.CustomSearchDomainName .CustomSearchDomain.CustomSearchDomainRealmUser .CustomSearchDomain.CustomSearchDomainRealmPassword}}"
