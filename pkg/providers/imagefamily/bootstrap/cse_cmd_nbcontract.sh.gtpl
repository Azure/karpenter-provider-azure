...
ENABLE_TLS_BOOTSTRAPPING="{{getBoolStringFromFeatureState .TlsBootstrappingConfig.TlsBootstrappingStatus}}"
ENABLE_SECURE_TLS_BOOTSTRAPPING="{{getBoolStringFromFeatureState .TlsBootstrappingConfig.SecureTlsBootstrappingStatus}}"
TLS_BOOTSTRAP_TOKEN="{{.TlsBootstrappingConfig.TlsBootstrapToken}}"
