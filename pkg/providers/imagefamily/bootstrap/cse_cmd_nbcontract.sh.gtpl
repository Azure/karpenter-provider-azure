...
NETWORK_MODE={{getStringFromNetworkModeType .NetworkConfig.GetNetworkMode}}
...
SUBNET={{.ClusterConfig.GetVirtualNetworkConfig.GetSubnet}}
ROUTE_TABLE={{.ClusterConfig.GetVirtualNetworkConfig.GetRouteTable}}
