...
var skusWithMissingPrice = map[string]float64{
	...
	// New SKUs that aren't yet in the pricing API (as of 2026-06-18)
	"Standard_ND128isr_GB300_v6": MissingPrice,
	"Standard_D16darm_V3":        MissingPrice,
	"Standard_D2darm_V3":         MissingPrice,
	"Standard_D32darm_V3":        MissingPrice,
	"Standard_D48darm_V3":        MissingPrice,
	"Standard_D4darm_V3":         MissingPrice,
	"Standard_D8darm_V3":         MissingPrice,
	"Standard_E16darm_V3":        MissingPrice,
	"Standard_E20darm_V3":        MissingPrice,
	"Standard_E2darm_V3":         MissingPrice,
	"Standard_E32darm_V3":        MissingPrice,
	"Standard_E48darm_V3":        MissingPrice,
	"Standard_E4darm_V3":         MissingPrice,
	"Standard_E8darm_V3":         MissingPrice,
}
