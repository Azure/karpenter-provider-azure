...
// SavingsPlanPrice represents a single Savings Plan price entry from the Azure Retail Prices API.
// Each entry corresponds to a commitment term (e.g., "1 Year" or "3 Years").
type SavingsPlanPrice struct {
	UnitPrice   float64 `json:"unitPrice"`
	RetailPrice float64 `json:"retailPrice"`
	Term        string  `json:"term"` // "1 Year" or "3 Years"
}
