...
func TestGetAKSGPUImageSHA(t *testing.T) {
	tests := []struct {
		...
		{"GRID v20 Driver - RTX PRO 6000 BSE", "standard_nc144lds_xl_rtxpro6000bse_v6", AKSGPUGridV20VersionSuffix, "grid-v20"},
		{"GRID v20 Driver - RTX PRO 6000 BSE mixed case", "Standard_NC288lds_xl_RTXPRO6000BSE_v6", AKSGPUGridV20VersionSuffix, "grid-v20"},
...
func TestGetGPUDriverVersion(t *testing.T) {
	tests := []struct {
		...
		{"GRID v20 Driver - RTX PRO 6000 BSE", "standard_nc144lds_xl_rtxpro6000bse_v6", NvidiaGridV20DriverVersion},
		{"GRID v20 Driver - RTX PRO 6000 BSE mixed case", "Standard_NC288lds_xl_RTXPRO6000BSE_v6", NvidiaGridV20DriverVersion},
...
func TestIsNvidiaEnabledSKU(t *testing.T) {
	tests := []struct {
		...
		{"Valid SKU - RTX PRO 6000 BSE", "standard_nc144lds_xl_rtxpro6000bse_v6", true},
		{"Valid SKU - RTX PRO 6000 BSE mixed case", "Standard_NC288lds_xl_RTXPRO6000BSE_v6", true},
		{"Empty SKU", "", false},
	}
...
func TestGetGPUManufacturer(t *testing.T) {
	tests := []struct {
		...
		{"NVIDIA SKU - RTX PRO 6000 BSE", "standard_nc144lds_xl_rtxpro6000bse_v6", "nvidia"},
...
func TestIsGPUSKUSupportedOnOS(t *testing.T) {
	tests := []struct {
		...
		{"RTX PRO 6000 BSE on Ubuntu", "standard_nc144lds_xl_rtxpro6000bse_v6", "ubuntu", true},
...
func TestIsDriverInstallSupported(t *testing.T) {
	tests := []struct {
		...
		{"NVIDIA RTX PRO 6000 BSE - has support", "standard_nc144lds_xl_rtxpro6000bse_v6", true},
