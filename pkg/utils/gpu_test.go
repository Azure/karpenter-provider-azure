...
func TestGetAKSGPUImageSHA(t *testing.T) {
	tests := []struct {
		...
		{"GRID v20 Driver - RTX PRO 6000 BSE GA ds", "standard_nc144ds_xl_rtxpro6000bse_v6", AKSGPUGridV20VersionSuffix, "grid-v20"},
		{"GRID v20 Driver - RTX PRO 6000 BSE GA lds", "standard_nc24lds_xl_rtxpro6000bse_v6", AKSGPUGridV20VersionSuffix, "grid-v20"},
...
func TestGetGPUDriverVersion(t *testing.T) {
	tests := []struct {
		...
		{"GRID v20 Driver - RTX PRO 6000 BSE GA ds", "standard_nc144ds_xl_rtxpro6000bse_v6", NvidiaGridV20DriverVersion},
		{"GRID v20 Driver - RTX PRO 6000 BSE GA lds", "standard_nc24lds_xl_rtxpro6000bse_v6", NvidiaGridV20DriverVersion},
...
func TestIsNvidiaEnabledSKU(t *testing.T) {
	tests := []struct {
		...
		{"Valid SKU - RTX PRO 6000 BSE GA ds", "standard_nc144ds_xl_rtxpro6000bse_v6", true},
		{"Valid SKU - RTX PRO 6000 BSE GA lds", "standard_nc144lds_xl_rtxpro6000bse_v6", true},
		{"Empty SKU", "", false},
	}
...
func TestGetGPUManufacturer(t *testing.T) {
	tests := []struct {
		...
		{"NVIDIA SKU - RTX PRO 6000 BSE GA ds", "standard_nc144ds_xl_rtxpro6000bse_v6", "nvidia"},
...
func TestIsGPUSKUSupportedOnOS(t *testing.T) {
	tests := []struct {
		...
		{"RTX PRO 6000 BSE GA ds on Ubuntu", "standard_nc144ds_xl_rtxpro6000bse_v6", "ubuntu", true},
		{"RTX PRO 6000 BSE GA ds on AzureLinux", "standard_nc144ds_xl_rtxpro6000bse_v6", "azurelinux", false},
...
func TestIsDriverInstallSupported(t *testing.T) {
	tests := []struct {
		...
		{"NVIDIA RTX PRO 6000 BSE GA lds - has support", "standard_nc24lds_xl_rtxpro6000bse_v6", true},
