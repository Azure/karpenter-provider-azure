...
func (c *CloudProvider) isNodeClassDrifted(ctx context.Context, nodeClaim *karpv1.NodeClaim, nodeClass *v1beta1.AKSNodeClass) (cloudprovider.DriftReason, error) { // XPMT: ☑️
...
// nolint: gocyclo
func (c *CloudProvider) isImageVersionDrifted( // XPMT: ☑️
	ctx context.Context,
	...
	if aksMachineName, isAKSMachine := instance.GetAKSMachineNameFromNodeClaim(nodeClaim); isAKSMachine {
		...
		// XPMT: (topic) AKS machine-NodeClaim conversion: retrieving VM image ID
...
func (c *CloudProvider) isMachineDriftActionAvailable(ctx context.Context, nodeClaim *karpv1.NodeClaim, _ *v1beta1.AKSNodeClass) (cloudprovider.DriftReason, error) {
	...
	if aksMachine.Properties != nil && aksMachine.Properties.Status != nil && aksMachine.Properties.Status.DriftAction != nil {
		...
		logger.V(1).Info("XPMT: AKS machine drift action",
