	...
	Context("ProvisionMode = AKSMachineAPIHeaderBatch", func() {
		...
		Context("Create - Additional Tags", func() {
			It("should add additional tags to the AKS machine", func() {
				...
				aksCloudProvider := New(aksAzureEnv.InstanceTypesProvider, aksAzureEnv.VMInstanceProvider, aksAzureEnv.AKSMachineProvider, nil, recorder, env.Client, aksAzureEnv.ImageProvider, aksAzureEnv.InstanceTypeStore)
