...
> Note: if you ever end up needing to use the extended log command to look back over a longer period of time, use the namespace `kube-system` instead of `karpenter`. <br>
> Replacement command:
> ```bash
