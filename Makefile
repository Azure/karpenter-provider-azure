...
e2etests: ## Run the e2e suite against your local cluster
	...
	# -v: verbose output
	cd test && CLUSTER_NAME=${CLUSTER_NAME} AZURE_ACR_NAME=${AZURE_ACR_NAME} AZURE_RESOURCE_GROUP_MC=${AZURE_RESOURCE_GROUP_MC} AZURE_SUBSCRIPTION_ID=${AZURE_SUBSCRIPTION_ID} AZURE_LOCATION=${AZURE_LOCATION} go test \
		-p 1 \
		-count 1 \
