...
# AKS (kubernetes.azure.com) labels validation for nodepool
# Restricts kubernetes.azure.com domain to only labels that Karpenter/AKS manages,
# syncing with AKS RP Machine API validation which blocks user-assigned
# kubernetes.azure.com/* labels.
