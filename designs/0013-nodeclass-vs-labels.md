...
- Well-known labels, which become scheduling requirements and are carried on `NodePool`, `NodeClaim`, and eventually nodes.
- Strongly typed fields on `AKSNodeClass`, which describe how Azure capacity should be provisioned.
